...
g++ $CFLAGS -c -o commandbuffer.o commandbuffer.cpp
g++ $CFLAGS -o vkdemo vkdemo.o \
    instance.o device.o queue.o image.o shadermodule.o pipeline.o commandbuffer.o $LDFLAGS
